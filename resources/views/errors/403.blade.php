...
<body>
    <div class="maincontainer">
        <div class="bat">
            <img class="wing leftwing" src="{{url('errors/403/bat-wing.png')}}">
            <img class="body" src="{{url('errors/403/bat-body.png')}}" alt="bat">
            <img class="wing rightwing" src="{{url('errors/403/bat-wing.png')}}">
        </div>
        <div class="bat">
            <img class="wing leftwing" src="{{url('errors/403/bat-wing.png')}}">
            <img class="body" src="{{url('errors/403/bat-body.png')}}" alt="bat">
        ...
        <img class="foregroundimg" src="{{url('errors/403/HauntedHouseForeground.png')}}" alt="haunted house">
